...
> 章节路径：持久化版 / HyG算法API / 算法API参数参考 / 三角计数算法（triangle_count）
> 来源：https://support.huaweicloud.com/intl/zh-cn/api-ges/ges_03_0500.html
...
| 参数 | 是否必选 | 类型 | 说明 |
---|---|---|---
statistics |  否 |  Boolean |  是否仅输出总的统计量结果，取值为true或false，默认为true。
  * true：仅输出总的统计数量。
  * false：输出各点对应三角形数量。
