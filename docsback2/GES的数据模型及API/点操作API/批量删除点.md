...
> 章节路径：持久化版 / 点操作API / 批量删除点
> 来源：https://support.huaweicloud.com/intl/zh-cn/api-ges/ges_03_0390.html
...
#### 请求示例
根据批量节点ID删除节点，待删除的点ID数组为Vivian和46。
```
    POST http://{SERVER_URL}/ges/v1.0/{project_id}/graphs/{graph_name}/vertices/action?action_id=batch-delete
    {
        "vertices": [
            "Vivian",
            "46"
